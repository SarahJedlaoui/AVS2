...
const Boarding1: React.FC = () => {
    const router = useRouter();


    const handleStartClick = () => {
        router.push("/on-boarding2"); // Replace with the actual path
    };
        ...
        >
            ...
            <Box sx={{ alignSelf: "flex-end", padding: 2 }}>
                <Typography
                    ...
                    onClick={() => router.push("/on-boarding2")}
                >
                    Skip
                </Typography>
            </Box>
            ...
            >
                ...
                <Typography variant="h5" sx={{ fontWeight: "bold", color: "#1A1A1A", marginBottom: 2, marginTop: 3 }}>
                    Welcome to AVS Intelligence
                </Typography>
                <Typography variant="body2" sx={{ color: "#6C757D", marginBottom: 3 }}>
                    A Smarter, Personalized Approach to Your Health
                </Typography>

                {/* Benefits List */}
                {["Access Your Health Data Easily.", "Personalized Health Insights.", "Better Health Management."].map(
                    (text, index) => (
                        <Box
                            key={index}
                            display="flex"
